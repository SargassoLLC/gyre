...
async fn main() -> anyhow::Result<()> {
    ...
    let hb_config = gyre::agent::HeartbeatConfig::default();
    ...
    match &result {
        ...
        gyre::agent::HeartbeatResult::Failed(err) => {
