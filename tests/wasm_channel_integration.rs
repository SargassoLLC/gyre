...
use gyre::channels::Channel;
use gyre::channels::wasm::{
...
mod loader_tests {
    ...
    async fn test_discover_channels_empty_dir() {
        ...
        let channels = gyre::channels::wasm::discover_channels(dir.path())
            .await
...
mod message_emission_tests {
    use super::*;
    use gyre::channels::wasm::{ChannelHostState, EmittedMessage};
