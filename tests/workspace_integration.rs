...
//! Set DATABASE_URL=postgres://localhost/gyre_test

use std::sync::Arc;

use gyre::workspace::{MockEmbeddings, SearchConfig, Workspace, paths};

fn get_pool() -> deadpool_postgres::Pool {
    let database_url = std::env::var("DATABASE_URL")
        .unwrap_or_else(|_| "postgres://localhost/gyre_test".to_string());
