...
async fn brain_handler(State(_state): State<Arc<GatewayState>>) -> Json<BrainResponse> {
    // Phase 12c: static mock data. Phase 13 will wire real CognitiveAgent data.
    let nodes = vec![
        BrainNode {
            id: "n1".into(),
            label: "identity".into(),
...
/// Shared logic: resolve the file inside `~/.gyre/projects/{project_id}/`,
