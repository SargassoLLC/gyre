...
use crate::cognitive::{AgentIdentityFiles, CognitiveContext};
...
pub struct AgentDeps {
    ...
    /// Optional cognitive layer (knowledge graph, memory stream, axioms).
    pub cognitive: Option<Arc<CognitiveContext>>,
    /// Optional agent identity files (soul, user context, memory summary).
    pub identity: Option<AgentIdentityFiles>,
}
