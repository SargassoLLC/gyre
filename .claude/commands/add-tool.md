...
Scaffold a new tool called `$ARGUMENTS` for the Gyre agent. First, determine the tool type and then follow the appropriate path.
...
version = "0.1.0"
edition = "2021"
description = "<Description> tool for Gyre (WASM component)"
