...
//! `gyre secret set github_token <token>`
//!
...
fn get_github_token() -> Result<String, String> {
    ...
    Err("GitHub token not found in secret store. Set it with: gyre secret set github_token <token>. \
