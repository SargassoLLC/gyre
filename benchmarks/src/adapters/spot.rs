...
impl BenchSuite for SpotSuite {
    ...
    fn additional_tools(&self) -> Vec<Arc<dyn gyre::tools::Tool>> {
        vec![
            Arc::new(gyre::tools::builtin::ShellTool::new()),
            Arc::new(gyre::tools::builtin::ReadFileTool::new()),
            Arc::new(gyre::tools::builtin::WriteFileTool::new()),
            Arc::new(gyre::tools::builtin::ListDirTool::new()),
            Arc::new(gyre::tools::builtin::ApplyPatchTool::new()),
        ]
    }
}
